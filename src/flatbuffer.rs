...
pub const ENUM_VALUES_DIRECTION: [Direction; 2] =
    [Direction::Server2Client, Direction::Client2Server];
...
impl Direction {
    pub const Server2Client: Self = Self(0);
    pub const Client2Server: Self = Self(1);

    pub const ENUM_MIN: i8 = 0;
    pub const ENUM_MAX: i8 = 1;
    pub const ENUM_VALUES: &'static [Self] = &[Self::Server2Client, Self::Client2Server];
    /// Returns the variant's name or "" if unknown.
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            Self::Server2Client => Some("Server2Client"),
            Self::Client2Server => Some("Client2Server"),
            _ => None,
        }
    }
}
...
impl<'a: 'b, 'b> DeleteSuccessBuilder<'a, 'b> {
    #[inline]
    pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> DeleteSuccessBuilder<'a, 'b> {
        let start = _fbb.start_table();
...
impl<'a: 'b, 'b> ErrorResponseBuilder<'a, 'b> {
    ...
    #[inline]
    pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> ErrorResponseBuilder<'a, 'b> {
        let start = _fbb.start_table();
...
impl<'a> Packet<'a> {
    ...
    pub fn direction(&self) -> Direction {
        ...
        unsafe {
            self._tab
                .get::<Direction>(Packet::VT_DIRECTION, Some(Direction::Server2Client))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn data(&self) -> Option<flatbuffers::Table<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Packet::VT_DATA, None)
        }
    }
    #[inline]
...
impl<'a: 'b, 'b> PacketBuilder<'a, 'b> {
    ...
    pub fn add_direction(&mut self, direction: Direction) {
        self.fbb_
            .push_slot::<Direction>(Packet::VT_DIRECTION, direction, Direction::Server2Client);
    }
    #[inline]
...
pub struct MessagesArgs<'a> {
    pub version: i16,
    pub packets: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Packet<'a>>>>,
    >,
}
